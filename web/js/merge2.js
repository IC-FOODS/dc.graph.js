var mergeDiagram = dc_graph.diagram('#graph');
...
var options = {
    ...
    gvattr: {
        ...
        exert: function(val, diagram) {
            if(val)
                dc_graph.apply_graphviz_accessors(mergeDiagram);
            else {
                mergeDiagram
...
var mergeDiagram = dc_graph.diagram('#graph');
var filters = {};
var sync_url = sync_url_options(options, dcgraph_domain(mergeDiagram), mergeDiagram, filters);
...
function apply_engine_parameters(engine) {
    ...
    mergeDiagram.initLayoutOnRedraw(engine.layoutAlgorithm() === 'cola');
    return engine;
}
...
//             return d.key;
//         }),
//         node_flat: dc_graph.flat_group.make(nodes, function(d) { 
...
//         colorDimension = data.node_flat.crossfilter.dimension(function(n) {
//             return n.color;
//         }),
//         colorGroup = colorDimension.group(),
//         dashDimension = data.edge_flat.crossfilter.dimension(function(e) {
//             return e.dash;
//         }),
//         dashGroup = dashDimension.group();
//     selectionDiagram
//         .nodeDimension(data.node_flat.dimension).nodeGroup(data.node_flat.group)
//         .edgeDimension(data.edge_flat.dimension).edgeGroup(data.edge_flat.group);
//     pie
...
// var populate = function(n, filename, error, data) {
// // var random = dc_graph.random_graph({
// //     ncolors: 3
// // });

// // random.generate(n);
// // mergeDiagram.generate(n);
//     if(error) {
//         var heading = '';
//         if(error.status)
...
//     // graph_data.generate(n);
//     // var some_data = build_data(graph_data.nodes(), graph_data.edges()),
//     //     colorDimension = some_data.node_flat.crossfilter.dimension(function(n) {
//     //         return n.color;
//     //     }),
//     //     colorGroup = colorDimension.group(),
//     //     dashDimension = some_data.edge_flat.crossfilter.dimension(function(e) {
//     //         return e.dash;
//     //     }),
//     //     dashGroup = dashDimension.group();
...
//     // mergeDiagram
//     //     .nodeDimension(some_data.node_flat.dimension).nodeGroup(some_data.node_flat.group)
//     //     .edgeDimension(some_data.edge_flat.dimension).edgeGroup(some_data.edge_flat.group);
//     // pie
//     //     .dimension(colorDimension)
//     //     .group(colorGroup);
//     // row
//     //     .dimension(dashDimension)
//     //     .group(dashGroup);
//     console.log("populate function activated")
// }
...
function on_load(filename, error, data) {
    ...
    mergeDiagram
        ...
        .nodeLabelFill(function(n) {
            var rgb = d3.rgb(mergeDiagram.nodeFillScale()(mergeDiagram.nodeFill()(n))),
    ...
    mergeDiagram.child('filter-selection-edges',
